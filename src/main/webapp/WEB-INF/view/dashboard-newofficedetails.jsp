                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processNewOfficeDetails" modelAttribute="newOfficeDetails" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <td>
                                                <form:input type="text" name="officeName" path="officeName"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <form:input type="text" name="level" path="level"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="position" path="position"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="department" path="department"></form:input>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <form:input type="text" name="branch" path="branch"></form:input>
                                            </td>
                                        </tr>

                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processNewContact" modelAttribute="empContact" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form:input type="text" name="email" path="email"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <form:input type="text" name="mobile" path="mobile"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="phone" path="phone"></form:input>
                                            </td>
                                        </tr>

                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <div>
                                <%
                                    boolean isClocked = (boolean)request.getAttribute("isClockedIn");
                                    if(!isClocked){
                                %>
                                <span><a href="/employee/clockIn" class="btn btn-success">Clock In</a></span>
                            <% }
                            else {
                            %>
                            <span><a href="/employee/clockOut" class="btn btn-danger">Clock Out</a></span>
                            <% } %>
                            </div>

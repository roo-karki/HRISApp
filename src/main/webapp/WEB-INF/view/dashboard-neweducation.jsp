                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processNewEducation" modelAttribute="newEducation" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form:input type="text" name="education.institution" path="education.institution"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <form:input type="text" name="education.level" path="education.level"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="education.board" path="education.board"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="education.year" path="education.year"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>I want to add another education details. </label>
                                            </td>
                                            <td>
                                                <input name="addAnotherEducation" path="addAnotherEducation" type="checkbox"/>
                                            </td>
                                        </tr>

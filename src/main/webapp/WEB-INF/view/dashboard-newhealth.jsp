                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processNewHealth" modelAttribute="newHealth" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input type="text" name="diagnosis" path="diagnosis"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="doctor" path="doctor"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                            <form:input type="text" name="emergencyContact" path="emergencyContact"></form:input>
                                            </td>
                                        </tr>

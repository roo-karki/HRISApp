            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <%
                            List<SimpleGrantedAuthority> authe = (List<SimpleGrantedAuthority>) SecurityContextHolder.getContext().getAuthentication().getAuthorities();
                            if(authe.get(0).toString().equals("ADMIN")){%>
                ...
                <%
                    ...
                    <tr>
                        ...
                        <td><%out.print(e.getPermAddress().getDistrict()+", "+e.getPermAddress().getMunicipality()+" - "+e.getPermAddress().getWard());%></td>
                        <td>
                            <a class="btn btn-info" href="employeedetails"><span class=text">Details</span></a>

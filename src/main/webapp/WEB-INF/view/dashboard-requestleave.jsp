...
<%@ page import="com.niraj.hrisApp.entity.employee.LeaveType" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processLeaveRequest" modelAttribute="newLeave" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <select name="leaveType">
                                                <% 
                                                    ArrayList<LeaveType> leaveList = (ArrayList<LeaveType>) request.getAttribute("leaveTypes");
                                                    for(LeaveType lt:leaveList){
                                                    
                                                %>
                                                
                                                <option value="<%out.print(lt.getLeaveTypeId());%>"><%out.print(lt.getLeaveType());%></option>
                                                <%
                                                    }
                                                %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input type="text" name="days" path="days"></form:input>
                                            </td>
                                        </tr>

...
<%@ page import="com.niraj.hrisApp.entity.employee.Leave" %>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <a class="btn btn-info" href="/employee/add"><span class=text align=right">New Employee</span></a>
                ...
                <%
                    ArrayList<Leave> leaveList = (ArrayList<Leave>)request.getAttribute("leaveRequestList");
                    for(Leave l: leaveList){ %>
                    <tr>
                        
                        <td><%out.print(l.getEmployee().getEmpId());%></td>
                        <td><%out.print(l.getEmployee().getName());%></td>
                        <td><%out.print(l.isApproved());%></td>
                        <td><%out.print(l.getLeaveType().getLeaveType());%></td>
                        <td><%out.print(l.getDays());%></td>
                        <td>
                            <%if(!l.isApproved()){%>
                            <a class="btn btn-success" href="approve/<%out.print(l.getLeaveId());%>"><span class=text">Approve</span></a>
                            <%}
                            else{%>
                            <button class="btn btn-success" disabled><span class=text">Approve</span></button>
                            <%}%>

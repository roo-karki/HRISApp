...
<%@ page import="com.niraj.hrisApp.entity.employee.Attendance" %>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <%
                    ArrayList<Attendance> attList = (ArrayList<Attendance>)request.getAttribute("listAttendance");
                    for(Attendance a: attList){ %>
                    <tr>
                        <td><%out.print(a.getAttId());%></td>
                        <td><%out.print(a.getEmp().getName());%></td>
                        
                        <td><%out.print(a.getDateIn());%></td>
                        <td><%out.print(a.getClockIn());%></td>
                        <td><%out.print(a.getClockOut());%></td>
                        <td>Blank</td>

                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <form:form action="processNewChild" modelAttribute="newChild" method="POST">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form:input type="text" name="child.name" path="child.name"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <form:input type="text" name="child.age" path="child.age"></form:input>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label>I want to add another Children details. </label>
                                            </td>
                                            <td>
                                                <input name="nextChild" path="nextChild" type="checkbox"/>
                                            </td>
                                        </tr>
